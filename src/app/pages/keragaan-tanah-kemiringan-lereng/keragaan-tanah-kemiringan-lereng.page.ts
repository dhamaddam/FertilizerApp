...
@Component({
  selector: 'app-keragaan-tanah-kemiringan-lereng',
  templateUrl: './keragaan-tanah-kemiringan-lereng.page.html',
  styleUrls: ['./keragaan-tanah-kemiringan-lereng.page.scss'],
})
export class KeragaanTanahKemiringanLerengPage implements OnInit {

  formTitle = "Kemiringan Lereng"
