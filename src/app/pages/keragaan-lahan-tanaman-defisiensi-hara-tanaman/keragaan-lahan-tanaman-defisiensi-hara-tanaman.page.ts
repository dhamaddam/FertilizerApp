...
@Component({
  selector: 'app-keragaan-lahan-tanaman-defisiensi-hara-tanaman',
  templateUrl: './keragaan-lahan-tanaman-defisiensi-hara-tanaman.page.html',
  styleUrls: ['./keragaan-lahan-tanaman-defisiensi-hara-tanaman.page.scss'],
})
export class KeragaanLahanTanamanDefisiensiHaraTanamanPage implements OnInit {

  formTitle = "Defisiensi Hara Tanaman"
  _allAfdelling : any[] = [];
  _allKebun : any[] = [];
  allCompany : any[] = [];
