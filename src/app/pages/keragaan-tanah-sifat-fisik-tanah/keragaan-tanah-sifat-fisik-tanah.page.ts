...
import { KeragaanTanahJenisTanahPage } from '../keragaan-tanah-jenis-tanah/keragaan-tanah-jenis-tanah.page';
import { KeragaanTanahService } from 'src/app/services/keragaan-tanah/keragaan-tanah.service';
import { IonicSelectableComponent } from 'ionic-selectable';
import { Port } from 'src/app/models/port';

@Component({
  selector: 'app-keragaan-tanah-sifat-fisik-tanah',
  templateUrl: './keragaan-tanah-sifat-fisik-tanah.page.html',
  styleUrls: ['./keragaan-tanah-sifat-fisik-tanah.page.scss'],
})
export class KeragaanTanahSifatFisikTanahPage implements OnInit {


  formTitle = "Sifat Fisik Tanah";
  myForm : any;
